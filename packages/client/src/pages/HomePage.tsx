...
import { Box, Heading, Text, Button, Container, VStack, SimpleGrid, useColorModeValue } from '@chakra-ui/react';
  ...
  return (
    <Container maxW="container.xl" py={8}>
      <VStack spacing={10} align="center" textAlign="center">
        <Box>
          <Heading as="h1" size="2xl" mb={4}>LLM Evaluation Tool</Heading>
        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={8} width="100%">
          <Box p={8} borderRadius="lg" bg={cardBg} boxShadow="md">
            <Heading as="h3" size="lg" mb={4}>Create & Manage Prompts</Heading>
            <Text mb={6}>
          ...
          <Box p={8} borderRadius="lg" bg={cardBg} boxShadow="md">
            <Heading as="h3" size="lg" mb={4}>Run Evaluations</Heading>
            <Text mb={6}>
